...
flowchart TD
    ...
    G --> B
```
### Направления решения задачи распределения функций между HW и SW
...
Возможность не принимать окончательное решение о разделении функций между аппаратной и программной частями до как можно более позднего момента (ресурсы ПЛИС – HW или SW)
![image](https://github.com/user-attachments/assets/f6874796-8f64-47c8-a791-f16136143227)  
### Проблемы, которые могут возникнуть при проектировании
Проблема принятия решения о распределении функций между аппаратной и программной частями проекта
Проблема разнородности этих частей
Проблема разработки этих частей разными командами с разным мышлением
## Идеи и методы сопряженного проектирования.
Откладывание вопроса о выделении конкретного исполнителя (для программной или аппаратной реализации) определенного поведенческого фрагмента системы на как можно более удаленный момент при условии, что описание поведения фрагмента существует и может использоваться для моделирования, а возможно даже для синтеза фрагмента  
Возможность не принимать окончательное решение о разделении функций между аппаратной и программной частями до как можно более позднего момента (ресурсы ПЛИС – HW или SW)
