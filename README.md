...
Разработчики нуждались в гибкой замене жёстко заданных логических схем, особенно при создании небольших партий цифровых устройств. Появились SPLD (`### SPLD` → `## SPLD`)
